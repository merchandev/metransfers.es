        ...
        <div class="container">
            <div class="ruta-cta-strip__inner">
                <div class="ruta-cta-strip__text">
                    <h2><?php echo mt_translate("¿No encuentras tu destino?"); ?></h2>
                    <p><?php echo mt_translate("Cotizamos cualquier ruta desde Barcelona a medida, sin compromiso."); ?></p>
                </div>
                <div class="ruta-cta-strip__actions">
                    <a href="<?php echo esc_url( home_url( '/contacto/' ) ); ?>" class="btn btn-primary"><?php echo mt_translate("Solicitar ruta personalizada"); ?></a>
