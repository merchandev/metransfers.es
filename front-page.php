    ...
    <div class="contact__grid">
      ...
      <div>
        ...
        <div style="margin-top:48px;">
          <button type="button" class="btn js-wa-trigger" aria-label="Contactar por WhatsApp" style="background:#25d366;color:#fff;border:none;box-shadow:0 8px 24px rgba(37,211,102,.3);padding:16px 32px;font-size:16px;">
      ...
      <form class="cform" id="mainContactForm">
        <div class="cform__row">
          <div class="fg"><label for="contact-nombre">Nombre y apellidos</label><input id="contact-nombre" type="text" name="nombre" autocomplete="name" required></div>
        ...
        <div class="cform__row">
          ...
          <div class="fg">
            <label for="contact-servicio">Servicio que necesitas</label>
        ...
        <div class="fg"><label for="contact-mensaje">Mensaje</label><textarea id="contact-mensaje" name="mensaje" rows="5" placeholder="Indica origen, destino, fecha, hora, pasajeros, equipaje y cualquier petición especial." required></textarea></div>
