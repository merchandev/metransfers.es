...
<section class="sp bg-white" id="servicios">
  <div class="wrap">
    <p class="tag tc" style="justify-content:center;">
        <?php echo mt_translate("Servicios de transporte privado en Barcelona"); ?>
    </p>
    <h2 class="tc">
      ...
      <div>
        <ul class="contact__list">
          ...
          <li class="contact__li">
            ...
            <div><div class="contact__label"><?php echo mt_translate("Email"); ?></div><a href="mailto:info@metransfers.es" class="contact__val">info@metransfers.es</a></div>
          </li>
          <li class="contact__li">
        ...
        <div style="margin-top:48px;">
          <button type="button" class="btn js-wa-trigger" aria-label="<?php echo mt_translate("Contactar por WhatsApp"); ?>" style="background:#25d366;color:#fff;border:none;box-shadow:0 8px 24px rgba(37,211,102,.3);padding:16px 32px;font-size:16px;">
