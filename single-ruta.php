...
<main id="primary" class="site-main ruta-page">
    ...
    <!-- HERO COMPACTO -->
    <section class="ruta-hero"<?php if ( $hero_bg ) echo ' style="background-image:url(' . esc_url( $hero_bg ) . ');"'; ?>>
        ...
        <div class="container ruta-hero__inner">
            <div class="ruta-hero__left gs-reveal">
                ...
                <div class="ruta-hero__actions">
                    ...
                    <a href="tel:+34935555555" class="btn btn-outline-white">
        ...
        <div class="container">
            <div class="ruta-cta-strip__inner">
                ...
                <div class="ruta-cta-strip__actions">
                    ...
                    <a href="https://wa.me/34935555555?text=Hola%2C+me+interesa+reservar+un+traslado" target="_blank" rel="noopener" class="btn btn-whatsapp">
