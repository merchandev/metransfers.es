        ...
        if ( $mt_lang && 'es' !== $mt_lang ) {
            ...
            if ( $post && is_string( $post->post_content ) ) {
                $search_shortcodes = array(
                    'wptb_booking_form', 'wptb_booking',
                    'wptb_popular_destinations_carousel', 'wptb_popular_destinations',
                    'wptb_booking_popup', 'premium_transfers_search',
                );
