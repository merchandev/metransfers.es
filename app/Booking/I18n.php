...
final class I18n {
    ...
    private static function spanish() {
        return array(
            ...
            'print_receipt'             => 'Imprimir o guardar como PDF',
            'receipt_unavailable'       => 'El recibo no está disponible o el enlace no es válido.',
    ...
    private static function english() {
        return array(
            ...
            'print_receipt'             => 'Print or save as PDF',
            'receipt_unavailable'       => 'The receipt is unavailable or the link is invalid.',
