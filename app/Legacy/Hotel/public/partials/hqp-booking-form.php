...
<div id="hqp-booking-wrapper" class="hqp-wrapper-dark">
    ...
    <div class="hqp-form-surface">
        <div class="hqp-progress" aria-label="Progreso de la reserva">
            <span class="hqp-progress-item is-active" data-step-indicator="1" aria-current="step"><b>1</b> Trayecto</span>
        ...
        <div id="hqp-feedback" class="hqp-error" role="alert" hidden></div>
        <form id="hqp-booking-form" class="hqp-form-dark" novalidate>
            ...
            <div class="hqp-step" id="hqp-step-1">
                ...
                <div class="hqp-row hqp-row-three">
                    <div class="hqp-col">
                        ...
                        <div class="hqp-input-wrapper-dark">
                            <input type="date" id="hqp-date" class="hqp-input-dark" required min="<?php echo esc_attr( ( new DateTimeImmutable( 'now', new DateTimeZone( 'Europe/Madrid' ) ) )->format( 'Y-m-d' ) ); ?>">
                        </div>
                    </div>
                    <div class="hqp-col">
                    ...
                    <div class="hqp-col">
                        ...
                        <div class="hqp-input-wrapper-dark">
                            <select id="hqp-passengers" class="hqp-input-dark" required>
                                <?php for ( $pax = 1; $pax <= ( isset( $max_passengers ) ? $max_passengers : 7 ); $pax++ ) : ?>
                ...
                <div class="hqp-actions">
                    ...
                    <p class="hqp-action-help">Consulta las opciones y el precio total para tu grupo.</p>
                </div>
            </div>
            ...
            <div class="hqp-step" id="hqp-step-2" style="display:none;">
                ...
                <div class="hqp-step-heading">
                    <h3 tabindex="-1">Elige tu vehículo</h3>
            ...
            <div class="hqp-step" id="hqp-step-3" style="display:none;">
                ...
                <div class="hqp-step-heading">
                    <h3 tabindex="-1">Completa tus datos</h3>
                ...
                <div class="hqp-actions">
                    ...
                    <p class="hqp-action-help">Te llevaremos al pago seguro para confirmar tu traslado.</p>
                </div>
            </div>
        </form>
    </div>
