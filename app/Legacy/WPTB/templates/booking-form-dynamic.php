...
<div id="wptb-step-1<?php echo esc_attr( $suffix ); ?>" class="booking-form active wptb-panel wptb-search-panel wptb-dynamic-search-panel">
        ...
        <div class="floating-label wptb-main-search-field wptb-search-field-region">
            ...
            <label for="wptb-destination-display<?php echo esc_attr( $suffix ); ?>"><?php echo esc_html( $wptb_i18n['destination_region'] ); ?></label>
        </div>
        ...
        <div class="floating-label wptb-main-search-field wptb-search-field-destination">
            ...
            <label for="wptb-destination<?php echo esc_attr( $suffix ); ?>"><?php echo esc_html( $wptb_i18n['exact_address'] ); ?></label>
        </div>
...
<div id="wptb-step-2" class="booking-vehicle-selection wptb-panel wptb-vehicle-panel is-hidden">
    ...
    <button type="button" id="wptb-back-step2<?php echo esc_attr( $suffix ); ?>" class="btn btn-outline wptb-back-search-btn" style="margin-top: 24px; display: flex; margin-inline: auto;"><?php echo esc_html( $wptb_i18n['change_search'] ); ?></button>
</div>
