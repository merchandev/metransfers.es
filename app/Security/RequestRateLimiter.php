...
final class RequestRateLimiter {
	public static function consume( $bucket, $limit, $window_seconds ) {
		return self::consumeForIdentifier( $bucket, $limit, $window_seconds, self::clientIdentifier() );
	}

	public static function consumeForIdentifier( $bucket, $limit, $window_seconds, $identifier ) {
