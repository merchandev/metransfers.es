    ...
    foreach ( $seo_destinations as $dslug => $dname ) {
        foreach ( $seo_types as $tkey => $tdata ) {
            ...
            if ( $page ) {
                ...
                $c .= "<!-- wp:paragraph -->\n<p>Si viajas con amigos, familia o grupos grandes, disponemos de espaciosas furgonetas y minivans Mercedes-Benz con capacidad para hasta 7 pasajeros y todo su equipaje.</p>\n<!-- /wp:paragraph -->\n\n";
