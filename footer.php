	...
	<div class="footer-inner">
		...
		<div class="footer-grid">
			...
			<div class="footer-col footer-col--help">
				<p class="footer-col-title" style="display:none;"><?php echo esc_html( mt_translate( 'Ayuda' ) ); ?></p>
    ...
    <div class="wa-modal__box">
        ...
        <div class="wa-modal__header">
            ...
            <div>
                ...
                <span><?php echo esc_html( mt_translate( 'Normalmente responde al instante' ) ); ?></span>
            </div>
        </div>
        <div class="wa-modal__body">
            ...
            <form id="waForm">
                <div class="wa-fg">
                    <label for="wa-nombre" class="screen-reader-text"><?php echo esc_html( mt_translate( 'Nombre completo' ) ); ?></label>
                    <input id="wa-nombre" type="text" name="nombre" autocomplete="name" placeholder="<?php echo esc_attr( mt_translate( 'Tu nombre completo' ) ); ?>" required>
                </div>
                <div class="wa-fg">
                    <label for="wa-telefono" class="screen-reader-text"><?php echo esc_html( mt_translate( 'Teléfono' ) ); ?></label>
                    <input id="wa-telefono" type="tel" name="telefono" autocomplete="tel" placeholder="<?php echo esc_attr( mt_translate( 'Teléfono' ) ); ?>" required>
                </div>
                <div class="wa-fg">
                    <label for="wa-mensaje" class="screen-reader-text"><?php echo esc_html( mt_translate( 'Consulta' ) ); ?></label>
                    <textarea id="wa-mensaje" name="mensaje" placeholder="<?php echo esc_attr( mt_translate( 'Tu consulta...' ) ); ?>" required></textarea>
                </div>
                <div class="wa-fg" style="margin-bottom:15px; font-size:13px;">
                    <label style="display:flex; align-items:center; gap:8px; cursor:pointer;">
                        ...
                        <span><?php echo mt_translate("He leído y acepto la política de privacidad."); ?></span>
                    </label>
                </div>
                <button type="submit" class="wa-submit">
                	<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg> <?php echo mt_translate("Iniciar Chat"); ?>
                </button>
            </form>
        </div>
    </div>
