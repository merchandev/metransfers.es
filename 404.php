        ...
        <div class="container error-404-premium__inner">
            ...
            <div class="error-404-premium__content">
                ...
                <div class="error-404-premium__actions">
                    ...
                    <a href="<?php echo esc_url( me_transfers_get_section_url( 'panel' ) ); ?>" class="btn btn-outline">
                ...
                <div class="error-404-premium__search">
                    <form role="search" method="get" class="error-search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                        <div class="error-search-wrapper">
                            ...
                            <input type="search" class="error-search-input" placeholder="<?php echo esc_attr( mt_translate( 'Buscar en el sitio...' ) ); ?>" value="<?php echo get_search_query(); ?>" name="s" required />
                            <button type="submit" class="error-search-submit"><?php echo esc_html( mt_translate( 'Buscar' ) ); ?></button>
                        </div>
                    </form>
                </div>
